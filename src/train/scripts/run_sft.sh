...
model_name_or_path='/data/xiaomengxi/psychology/openai-quickstart-python/llama-2-7b-chat-hf' # or bloomz-7b1-mt

train_file=512raw.json
validation_file=512raw-dev1K.json
